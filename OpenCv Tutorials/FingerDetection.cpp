...
void filter_and_threshold(struct ctx *ctx)
{
	...
	cvInRangeS(ctx->temp_image3,
		   cvScalar(lowH,lowS, lowV, 255),
		   cvScalar(highH, highS, highV, 255),
		   ctx->thr_image);
...
int main(int argc, char **argv)
{
	...
	init_windows();
	init_ctx(&ctx);
	cvCreateTrackbar("LowH","thresholded",&lowH,255);
	cvCreateTrackbar("HighH","thresholded",&highH,255);
	cvCreateTrackbar("LowS","thresholded",&lowS,255);
	cvCreateTrackbar("HighS","thresholded",&highS,255);
	cvCreateTrackbar("LowV","thresholded",&lowV,255);
	cvCreateTrackbar("HighV","thresholded",&highV,255);
